...
func TestParseProxyURL_Socks5(t *testing.T) {
	r, err := parseProxyURL("socks5://user:pass@1.2.3.4:1080")
	if err != nil {
...
func TestParseProxyURL_Socks5NoAuth(t *testing.T) {
	r, err := parseProxyURL("socks5://1.2.3.4:1080")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if len(r.Params) != 0 {
...
func TestParseProxyURL_HTTP(t *testing.T) {
	r, err := parseProxyURL("http://admin:secret@10.0.0.1:8080")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if r.Type != "http" {
...
func TestParseProxyURL_SSBase64(t *testing.T) {
	// base64("aes-256-gcm:mypass") = "YWVzLTI1Ni1nY206bXlwYXNz"
	r, err := parseProxyURL("ss://YWVzLTI1Ni1nY206bXlwYXNz@1.2.3.4:8388")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if r.Type != "ss" {
...
func TestParseProxyURL_SSPlainUserinfo(t *testing.T) {
	r, err := parseProxyURL("ss://aes-256-gcm:mypass@1.2.3.4:8388")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestParseProxyURL_SSWithPlugin(t *testing.T) {
	r, err := parseProxyURL("ss://YWVzLTI1Ni1nY206bXlwYXNz@1.2.3.4:8388?plugin=obfs-local%3Bobfs%3Dhttp%3Bobfs-host%3Dexample.com")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if r.Plugin == nil {
...
func TestParseProxyURL_SSFragmentIgnored(t *testing.T) {
	r, err := parseProxyURL("ss://YWVzLTI1Ni1nY206bXlwYXNz@1.2.3.4:8388#SomeNodeName")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestParseProxyURL_IPv6(t *testing.T) {
	r, err := parseProxyURL("socks5://[::1]:1080")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestParseProxyURL_UnsupportedScheme(t *testing.T) {
	_, err := parseProxyURL("vmess://1.2.3.4:1080")
	if err == nil {
...
func TestParseProxyURL_MissingPort(t *testing.T) {
	_, err := parseProxyURL("socks5://1.2.3.4")
	if err == nil {
...
func TestParseProxyURL_PortOutOfRange(t *testing.T) {
	_, err := parseProxyURL("socks5://1.2.3.4:70000")
	if err == nil {
		t.Fatal("expected error for port out of range")
	}
}

func TestParseProxyURL_Socks5RejectsPath(t *testing.T) {
	_, err := parseProxyURL("socks5://1.2.3.4:1080/typo")
	if err == nil {
		t.Fatal("expected error for socks5 path")
	}
}

func TestParseProxyURL_Socks5RejectsTrailingSlash(t *testing.T) {
	_, err := parseProxyURL("socks5://1.2.3.4:1080/")
	if err == nil {
		t.Fatal("expected error for trailing slash")
	}
}

func TestParseProxyURL_HTTPRejectsQuery(t *testing.T) {
	_, err := parseProxyURL("http://1.2.3.4:8080?foo=bar")
	if err == nil {
		t.Fatal("expected error for http query")
	}
}

func TestParseProxyURL_Socks5RejectsFragment(t *testing.T) {
	_, err := parseProxyURL("socks5://1.2.3.4:1080#frag")
	if err == nil {
		t.Fatal("expected error for socks5 fragment")
	}
}

func TestParseProxyURL_SSMissingAt(t *testing.T) {
	_, err := parseProxyURL("ss://YWVzLTI1Ni1nY206bXlwYXNz")
	if err == nil {
		t.Fatal("expected error for SS URI missing @")
	}
}

func TestParseProxyURL_SSEmptyHost(t *testing.T) {
	_, err := parseProxyURL("ss://YWVzLTI1Ni1nY206bXlwYXNz@:8388")
	if err == nil {
		t.Fatal("expected error for empty host")
	}
}

func TestParseProxyURL_SSPortBoundary(t *testing.T) {
	r, err := parseProxyURL("ss://YWVzLTI1Ni1nY206bXlwYXNz@1.2.3.4:65535")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if r.Port != 65535 {
